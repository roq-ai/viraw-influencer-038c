...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['marketing-manager', 'business-owner', 'data-analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Campaign', path: '/campaigns', entity: 'campaign', service: AccessServiceEnum.PROJECT, icon: FiBox },
