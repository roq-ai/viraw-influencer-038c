...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Marketing Manager'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Business Owner', 'Marketing Manager', 'Data Analyst'];
  const addOns: string[] = ['file', 'notifications'];
  const applicationName = `Viraw Influencers`;
